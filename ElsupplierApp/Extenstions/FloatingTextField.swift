...
class FloatingTextField: UITextField, UITextFieldDelegate {
    ...
    @IBInspectable var FieldBoarderColor:UIColor = UIColor.black
    @IBInspectable var FieldBorderWidth: CGFloat = 0.0
    @IBInspectable var FieldCornerRadius: CGFloat = 1.0
...
extension FloatingTextField {
    ...
    private func textFieldBorderSetup() {
        ...
        self.layer.borderColor = FieldBoarderColor.cgColor
        self.layer.borderWidth = FieldBorderWidth
        //turnery
        if RoundCorner {
            self.layer.cornerRadius = self.frame.size.height/2
        }else {
            self.layer.cornerRadius = FieldCornerRadius
        }
